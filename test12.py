...
#########If it finds a shorter path (one that just links the var with the goal):
#Have it save that path to a list, and delete the entire way from teh one going through the searching loops.
#At teh end of the program, update the temp list with the list that these shorter ways get solved to.
##Have the solver function try doing it teh shorter ways first.
